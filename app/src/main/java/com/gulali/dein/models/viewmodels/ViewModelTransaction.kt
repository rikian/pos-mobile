...
class ViewModelTransaction: ViewModel() {
    ...
    var idTransaction = ""
    var dtoTransaction = DtoTransaction(
        totalItem= 0,
        subTotalProduct= 0,
        discountNominal= 0,
        discountPercent= 0.0,
    ...
    var transactionItem: MutableList<DtoTransactionItem> = mutableListOf()
    var productList: MutableList<DtoProduct> = mutableListOf()
    var exchangeDiscount: DtoPercentNominal = DtoPercentNominal()
    var exchangeTax: DtoPercentNominal = DtoPercentNominal()
}