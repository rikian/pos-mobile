...
import com.gulali.dein.service.ProductUpdateStock

class ContractProductStock (private val constant: Constants): ActivityResultContract<Int, DtoContractProductDetail?>() {
    override fun createIntent(context: Context, input: Int): Intent {
        return Intent(context, ProductUpdateStock::class.java).apply {
